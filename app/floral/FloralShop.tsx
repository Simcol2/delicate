...
export default function FloralShop({ categoryName, items }: Props) {
  ...
  if (items.length === 0) {
    return (
      <section className="max-w-[1180px] mx-auto px-6 lg:px-10 py-16 sm:py-20">
        <div className="bg-white/80 border border-[#1F4D4F]/10 p-8 sm:p-12 text-center shadow-[0_18px_50px_rgba(31,77,79,0.08)]">
          <p className="font-sans text-[0.62rem] tracking-[0.3em] uppercase text-[#FF6F61] mb-4">
            {categoryName}
          </p>
          <h2 className="font-serif text-3xl sm:text-4xl text-[#1F4D4F]">
            Fresh florals are being added.
          </h2>
          <p className="font-serif text-lg text-[#5A625F] mt-4 max-w-xl mx-auto">
