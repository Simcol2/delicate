  ...
  return (
    <>
      ...
      <section className="lg:hidden relative overflow-hidden bg-[#F8F3E9]">
        ...
        {/* Extra palm shadow under arrangement */}
        <div
          className="absolute right-[2%] bottom-[8%] w-[46%] h-[22%] pointer-events-none opacity-[0.12]"
          style={{
            backgroundImage: 'url(/images/palm-shadow.png)',
            backgroundRepeat: 'no-repeat',
            backgroundSize: 'contain',
        ...
        {/* Floral arrangement, moved down slightly */}
        <img
